...
-  [**FastAPI**](https://fastapi.tiangolo.com) с поддержкой asyncio для асинхронной работы в качестве внутреннего API Python.
    -  [SQLModel](https://sqlmodel.tiangolo.com) для асинхронного взаимодействия с базой данных SQL (ORM).
    -  [Pydantic](https://docs.pydantic.dev), используемый FastAPI для проверки данных и управления настройками.
-  [PostgreSQL](https://www.postgresql.org) с поддержкой asyncio для асинхронной работы в качестве базы данных SQL.
