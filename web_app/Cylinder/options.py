...
from web_app.utils.options import clicked_main_menu, insert_image, option_input
...
option_input_cyl = option_input(
    func_img_from_type=_img_from_type_cyl,
...
clicked_main_menu_cyl = clicked_main_menu(
    metadata=metadata,
