...
def gui_main_mot():
    ...
    btn_V = tk.Button(
        main_window_mot,
        text="V(см3) - расчёт рабочего объёма",
        font=(font[0], 12),
    ...
    btn_n = tk.Button(
        main_window_mot,
        text="n(об/мин) - расчёт скорости вращения",
        font=(font[0], 12),
    ...
    btn_Q = tk.Button(
        main_window_mot,
        text="Q(л/мин) - расчёт требуемой подачи",
        font=(font[0], 12),
    ...
    btn_p = tk.Button(
        main_window_mot,
        text="p(Bar) - расчет требуемого давления(перепад давления)",
        font=(font[0], 12),
    ...
    btn_M = tk.Button(
        main_window_mot,
        text="M(даН*м) - расчёт вращающего момента ведомого вала",
        font=(font[0], 12),
    ...
    btn_P = tk.Button(
        main_window_mot,
        text="P(кВт) - расчёт мощности ведомого вала",
        font=(font[0], 12),
        command=click_main_menu(lbl_P, P),
        **btn_master,
    )
